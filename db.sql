...
CREATE TABLE `settings` (
  ...
  `config_mail_oauth_app_tenant_id` varchar(255) DEFAULT NULL,
  `config_mail_oauth_app_client_id` varchar(255) DEFAULT NULL,
  `config_mail_oauth_app_client_secret` varchar(255) DEFAULT NULL,
  `config_mail_oauth_app_access_token` text DEFAULT NULL,
  `config_mail_oauth_app_access_token_expires_at` datetime DEFAULT NULL,
